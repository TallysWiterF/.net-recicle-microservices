...
namespace WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c => c.SwaggerDoc("v1", new OpenApiInfo { Title = "API Perfis", Description = "Direcionada para gerenciar perfis relacionados à um usuário", Version = "v1" }));
