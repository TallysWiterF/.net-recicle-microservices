...
namespace WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c => c.SwaggerDoc("v1", new OpenApiInfo { Title = "API Leitura", Description = "Direcionada para a centralização de dados para leitura", Version = "v1" }));
